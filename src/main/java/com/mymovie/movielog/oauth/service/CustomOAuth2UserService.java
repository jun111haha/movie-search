...
import com.mymovie.movielog.oauth.exception.OAuthProviderMissMatchException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User process(OAuth2UserRequest userRequest, OAuth2User user) {
        ...
        if (savedUser != null) {
            if (providerType != savedUser.getProviderType()) {
                throw new OAuthProviderMissMatchException("Looks like you're signed up with " + providerType + " account. Please use your " + savedUser.getProviderType() + " account to login.");
            }
    ...
    private User createUser(OAuth2UserInfo userInfo, ProviderType providerType) {
        ...
        User user = new User(userInfo.getId(), userInfo.getName(), userInfo.getEmail(), "Y", userInfo.getImageUrl(), providerType, RoleType.USER);
